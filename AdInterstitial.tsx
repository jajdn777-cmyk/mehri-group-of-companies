          ...
          >
            ...
            <div className="p-8 md:p-14 text-center space-y-8 relative z-30">
              <div className="space-y-4">
                ...
                >
                  Master your health with the precision Mehri fitness tracker. Now syncing with AI-powered calorie tracking 3.0.
                </motion.p>
              </div>
              ...
              <div className="flex justify-center gap-8 opacity-20">
                 ...
                 <span className="text-[8px] font-black uppercase tracking-widest text-slate-900">Mehri Group 2026</span>
                 <div className="h-px bg-slate-900 flex-1 self-center" />
              </div>
            </div>
          </motion.div>
