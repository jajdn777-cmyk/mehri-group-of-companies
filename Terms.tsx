...
export const TermsView = ({ onNavigate }: any) => {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 animate-fade-in">
      ...
      <div className="pt-40 pb-32 px-6 max-w-4xl mx-auto">
         <div className="mb-16">
            <h1 className="text-5xl md:text-6xl font-black text-slate-900 uppercase tracking-tighter mb-6">Terms of Service</h1>
            <p className="text-xl text-slate-500 font-medium leading-relaxed max-w-2xl">
               MEHRI Group Terms of Service and User Agreement.
            </p>
         </div>
         ...
         <div className="mt-20 pt-10 border-t border-slate-100 text-center text-slate-400 text-xs font-bold uppercase tracking-widest">
            Last Updated: January 2026 • San Francisco, CA • MEHRI Legal Division
         </div>
      </div>
    </div>
  );
