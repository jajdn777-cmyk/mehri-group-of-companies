...
5. AI INTERACTION DISCLAIMER (ALMA INTELLIGENCE)
The "Alma" coaching assistant utilizes Large Language Models (LLMs) to interpret your health data. While we strive for accuracy:
- Alma is an informational tool, NOT a medical practitioner.
- Interactions with Alma are processed via secure cloud inference APIs. Contextual data sent to the model is ephemeral and not used to train public models.
