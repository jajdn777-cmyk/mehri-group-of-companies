...
The MEHRI Group ("we," "us," or "our") operates at the intersection of biotechnology, consumer electronics, and artificial intelligence. This Privacy Policy governs your use of the Mehri Group platform, the Mehri fitness tracker hardware, and the AI Coach coaching interface. We are committed to transparency regarding the collection, encryption, and utilization of your physiological data. This policy applies to users globally, with specific addendums for residents of the European Economic Area (EEA), California (CCPA/CPRA), and Brazil (LGPD).

2. BIOMETRIC DATA CONTROLLER & PROCESSING
MEHRI Group acts as the Data Controller for your personal information.
- Biometric Data Collection: When you use the Mehri fitness tracker, we collect high-frequency physiological telemetry including but not limited to: Heart Rate Variability (HRV), Blood Oxygen Saturation (SpO2), Accelerometer patterns (Gait Analysis), and Sleep Staging blueprint (REM/Deep/Light cycles).
- Purpose of Processing: This data is processed strictly to provide: (a) Real-time performance analytics; (b) "AI" AI-driven coaching insights; and (c) Long-term health trend visualization.
...
We employ military-grade security blueprints to protect your digital biological profile.
...
- Anonymization: For the purpose of improving the AI neural engine, data is stripped of all Personally Identifiable Information (PII) before being used in aggregate training sets.
...
5. AI INTERACTION DISCLAIMER (AI SYSTEM)
The "AI" coaching assistant utilizes Large Language Models (LLMs) to interpret your health data. While we strive for accuracy:
- AI is an informational tool, NOT a medical practitioner.
- Interactions with AI are processed via secure cloud inference APIs. Contextual data sent to the model is ephemeral and not used to train public models.
...
- No Medical Advice: The data, insights, text, graphics, and suggestions provided by the "AI" AI coach are for informational and recreational purposes only. They are not intended to diagnose, treat, cure, or prevent any disease.
...
export const FAQ_DATA = [
  ...
  },
  {
    ...
    answer: "We utilize decentralized encryption for all health data. Unlike standard trackers, AI Insights processes sensitive biometrics locally on the device or through secure, end-to-end encrypted tunnels, ensuring your health insights remain your private property and are never sold to third-party advertisers."
  },
  {
    question: "What makes the Mehri fitness tracker different from a standard Apple Watch or Garmin?",
    answer: "The Mehri fitness tracker bridges the gap between a rugged sports watch and an personal accessory. It features \"AI Coach Coaching,\" which doesn't just show you steps—it analyzes your sleep and strain to tell you exactly when to work out and when to rest for peak performance."
  },
  {
    question: "Does the Mehri fitness tracker require a monthly subscription for AI features?",
    answer: "No. Unlike many 2026 wearables that paywall your own data, the Mehri fitness tracker offers all core AI health insights, sleep analytics, and the AI Insights dashboard with no hidden monthly fees. You own the hardware and the insights for life."
  },
  {
    question: "How does the \"AI Insights\" AI coaching actually work?",
    answer: "AI Coach uses a proprietary machine learning model to correlate your heart rate, sleep stages, and daily activity. It builds a \"Digital Twin\" of your physiology to predict fatigue before you feel it, providing actionable notifications like \"Your recovery is low; prioritize 20 more minutes of REM sleep tonight.\""
  },
  {
    question: "Can I use the Mehri fitness tracker for contactless payments and smart home control?",
    answer: "Yes. The Mehri Series 1 includes integrated NFC for universal contactless payments and a built-in IoT hub, allowing you to control your \"AI Smart Home\" devices directly from your wrist using simple haptic gestures or voice commands."
  }
];
